...
public final class Constants {
    ...
    public static final int REARLEFT_ID = 0;
    public static final int REARRIGHT_ID = 1;
    public static final int FRONTLEFT_ID = 2;
    public static final int FRONTRIGHT_ID = 3;

    public static final int REAR_LEFT_ENCODER = 4;
    public static final int REAR_RIGHT_ENCODER = 5;
